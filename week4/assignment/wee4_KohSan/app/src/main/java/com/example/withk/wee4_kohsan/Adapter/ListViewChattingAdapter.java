 ...
 *public class ListViewChattingAdapter extends BaseAdapter {

 *    private LayoutInflater inflater;
 *    private ArrayList<com.example.withk.wee4_kohsan.ListViewItemFriends> items;
 *    private int layout;
 *
 *    public ListViewChattingAdapter(Context context, int layout, ArrayList<com.example.withk.wee4_kohsan.ListViewItemChatting> data) {
